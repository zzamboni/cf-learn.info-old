...
[search the CFEngine documentation for 'inputs'](http://docs.cfengine.com/latest/search.html?q=inputs).
...
- [inputs \#\#\#\#\#](http://docs.cfengine.com/latest/guide-writing-and-serving-policy-policy-framework.html#inputs-#####)
- [inputs](http://docs.cfengine.com/latest/reference-components.html#inputs)

...
[search the CFEngine documentation for 'value'](http://cfengine.com/docs/latest/search.html?q=value).
...
- [field_value](http://cfengine.com/docs/latest/reference-promise-types-edit_line-field_edits.html#field_value)
...
- [bundle_return_value_index](http://cfengine.com/docs/latest/reference-promise-types-reports.html#bundle_return_value_index)
- [value_kept](http://cfengine.com/docs/latest/reference-promise-types.html#value_kept)
- [value_repaired](http://cfengine.com/docs/latest/reference-promise-types.html#value_repaired)
- [value_notkept](http://cfengine.com/docs/latest/reference-promise-types.html#value_notkept)

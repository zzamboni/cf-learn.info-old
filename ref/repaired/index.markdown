...
pageurl: /ref/repaired
posttitle: Reference disambiguation for 'repaired'
navsection: none
---

The term 'repaired' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'repaired'](http://cfengine.com/docs/latest/search.html?q=repaired).
...
- [log_repaired](http://cfengine.com/docs/latest/reference-promise-types.html#log_repaired)

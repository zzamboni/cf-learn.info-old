...
pageurl: /ref/virtual
posttitle: Reference disambiguation for 'virtual'
navsection: none
---

The term 'virtual' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'virtual'](http://cfengine.com/docs/latest/search.html?q=virtual).

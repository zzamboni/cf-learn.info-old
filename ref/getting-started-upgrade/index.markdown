...
pageurl: /ref/getting-started-upgrade
posttitle: Reference disambiguation for 'getting-started-upgrade'
navsection: none
---

The term 'getting-started-upgrade' could refer to several sections in the documentation. Please choose one below, or
...
- [Manual](http://cfengine.com/docs/3.5/getting-started-upgrade.html#manual)

...
pageurl: /ref/3.5
posttitle: Reference disambiguation for '3.5'
navsection: none
---

The term '3.5' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for '3.5'](http://docs.cfengine.com/latest/search.html?q=3.5).
...
- [Enterprise reports not collected from 3.5](http://docs.cfengine.com/latest/guide-latest-release-known-issues.html#enterprise-reports-not-collected-from-3-5)

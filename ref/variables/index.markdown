...
pageurl: /ref/variables
posttitle: Reference disambiguation for 'variables'
navsection: none
---

The term 'variables' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'variables'](http://cfengine.com/docs/3.5/search.html?q=variables).

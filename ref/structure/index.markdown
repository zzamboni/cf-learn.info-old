...
[search the CFEngine documentation for 'structure'](http://docs.cfengine.com/latest/search.html?q=structure).
...
- [CFEngine Directory Structure](http://docs.cfengine.com/latest/guide-introduction-directory-structure.html#cfengine-directory-structure)
- [Further structure \#\#](http://docs.cfengine.com/latest/guide-writing-and-serving-policy-policy-framework.html#further-structure-##)
- [Sketch Structure](http://docs.cfengine.com/latest/reference-design-center-sketch.html#sketch-structure)

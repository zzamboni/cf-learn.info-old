...
pageurl: /ref/from
posttitle: Reference disambiguation for 'from'
navsection: none
---

The term 'from' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'from'](http://cfengine.com/docs/latest/search.html?q=from).
...
- [Enterprise and Community Users can Write Sketches from the Command Line](http://cfengine.com/docs/latest/guide-design-center-design-center-write-sketch-advanced.html#enterprise-and-community-users-can-write-sketches-from-the-command-line)
...
- [copy_from](http://cfengine.com/docs/latest/reference-promise-types-files.html#copy_from)
- [link_from](http://cfengine.com/docs/latest/reference-promise-types-files.html#link_from)

...
pageurl: /ref/reference-special-variables-context-mon
posttitle: Reference disambiguation for 'reference-special-variables-context-mon'
navsection: none
---

The term 'reference-special-variables-context-mon' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'reference-special-variables-context-mon'](http://cfengine.com/docs/3.5/search.html?q=reference-special-variables-context-mon).

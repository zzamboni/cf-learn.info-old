...
pageurl: /ref/mode
posttitle: Reference disambiguation for 'mode'
navsection: none
---

The term 'mode' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'mode'](http://cfengine.com/docs/3.5/search.html?q=mode).
...
- [fips_mode](http://cfengine.com/docs/3.5/reference-components.html#fips_mode)

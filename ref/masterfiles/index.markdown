...
[search the CFEngine documentation for 'masterfiles'](http://docs.cfengine.com/latest/search.html?q=masterfiles).
...
- [/opt/cfengine/userworkdir/$(user)/masterfiles](http://docs.cfengine.com/latest/enterprise-cfengine-guide-design-center-configure-sketches-enterprise-enterprise-sketch-flow.html#opt-cfengine-userworkdir-user-masterfiles)
...
- [cfengine_internal_masterfiles_update](http://docs.cfengine.com/latest/guide-writing-and-serving-policy-policy-framework.html#cfengine_internal_masterfiles_update)

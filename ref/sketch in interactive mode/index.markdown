...
pageurl: /ref/sketch in interactive mode
posttitle: Reference disambiguation for 'sketch in interactive mode'
navsection: none
---

The term 'sketch in interactive mode' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'sketch in interactive mode'](http://cfengine.com/docs/latest/search.html?q=sketch+in+interactive+mode).

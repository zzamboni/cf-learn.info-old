...
pageurl: /ref/log
posttitle: Reference disambiguation for 'log'
navsection: none
---

The term 'log' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'log'](http://docs.cfengine.com/latest/search.html?q=log).
...
- [Example: Changing The Log Level](http://docs.cfengine.com/latest/examples-enterprise-api-examples-managing-settings.html#example-changing-the-log-level)
- [Log rotation](http://docs.cfengine.com/latest/examples-example-snippets-system-file.html#log-rotation)
...
- [Log Files in /var/cfengine \#\#](http://docs.cfengine.com/latest/guide-introduction-directory-structure.html#log-files-in-var-cfengine-##)
...
- [ospf_log_adjacency_changes](http://docs.cfengine.com/latest/reference-components-routing_services_control.html#ospf_log_adjacency_changes)
- [ospf_log_timestamp_precision](http://docs.cfengine.com/latest/reference-components-routing_services_control.html#ospf_log_timestamp_precision)
...
- [log_string](http://docs.cfengine.com/latest/reference-promise-types.html#log_string)
- [log_kept](http://docs.cfengine.com/latest/reference-promise-types.html#log_kept)
- [log_repaired](http://docs.cfengine.com/latest/reference-promise-types.html#log_repaired)
- [log_failed](http://docs.cfengine.com/latest/reference-promise-types.html#log_failed)
- [log_level](http://docs.cfengine.com/latest/reference-promise-types.html#log_level)

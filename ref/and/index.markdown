...
pageurl: /ref/and
posttitle: Reference disambiguation for 'and'
navsection: none
---

The term 'and' could refer to several sections in the documentation. Please choose one:
...
- [1.8 Filenames and paths](https://cfengine.com/manuals/cf3-Reference#Filenames-and-paths)
...
- [2.10 Loops and lists in CFEngine 3](https://cfengine.com/manuals/cf3-Reference#Loops-and-lists-in-CFEngine-3)
- [2.11 Pattern matching and referencing](https://cfengine.com/manuals/cf3-Reference#Pattern-matching-and-referencing)
- [6.1.1 <code>and</code>](https://cfengine.com/manuals/cf3-Reference#and-in-classes)

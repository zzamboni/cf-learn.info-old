...
pageurl: /ref/bgp
posttitle: Reference disambiguation for 'bgp'
navsection: none
---

The term 'bgp' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'bgp'](http://cfengine.com/docs/latest/search.html?q=bgp).

- [ospf_redistribute_bgp_metric](http://cfengine.com/docs/latest/reference-components-routing_services_control.html#ospf_redistribute_bgp_metric)
- [bgp_local_as](http://cfengine.com/docs/latest/reference-components-routing_services_control.html#bgp_local_as)
...
- [bgp_redistribute](http://cfengine.com/docs/latest/reference-components-routing_services_control.html#bgp_redistribute)
...
- [bgp_graceful_restart](http://cfengine.com/docs/latest/reference-components-routing_services_control.html#bgp_graceful_restart)
- [bgp_session_neighbor](http://cfengine.com/docs/latest/reference-promise-types-interfaces.html#bgp_session_neighbor)
- [bgp_peer_as](http://cfengine.com/docs/latest/reference-promise-types-interfaces.html#bgp_peer_as)
...
- [bgp_advertise_families](http://cfengine.com/docs/latest/reference-promise-types-interfaces.html#bgp_advertise_families)

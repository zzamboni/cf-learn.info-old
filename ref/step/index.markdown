...
pageurl: /ref/step
posttitle: Reference disambiguation for 'step'
navsection: none
---

The term 'step' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'step'](http://cfengine.com/docs/latest/search.html?q=step).
...
- [Agent pre-evaluation step](http://cfengine.com/docs/latest/guide-language-concepts-normal-ordering.html#agent-pre-evaluation-step)
- [Agent evaluation step](http://cfengine.com/docs/latest/guide-language-concepts-normal-ordering.html#agent-evaluation-step)

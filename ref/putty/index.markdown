...
pageurl: /ref/putty
posttitle: Reference disambiguation for 'putty'
navsection: none
---

The term 'putty' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'putty'](http://docs.cfengine.com/latest/search.html?q=putty).

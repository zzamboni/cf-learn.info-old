...
[search the CFEngine documentation for 'logs'](http://cfengine.com/docs/latest/search.html?q=logs).
...
- [Redirecting output to logs](http://cfengine.com/docs/latest/guide-reporting-command-line-reports.html#redirecting-output-to-logs)

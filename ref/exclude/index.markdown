...
The term 'exclude' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'exclude'](http://cfengine.com/docs/3.5/search.html?q=exclude).

- [exclude_hosts](http://cfengine.com/docs/3.5/reference-components-cfhub.html#exclude_hosts)

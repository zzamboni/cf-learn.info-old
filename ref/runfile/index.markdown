...
pageurl: /ref/runfile
posttitle: Reference disambiguation for 'runfile'
navsection: none
---

The term 'runfile' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'runfile'](http://docs.cfengine.com/latest/search.html?q=runfile).

- [Generate and execute the runfile](http://docs.cfengine.com/latest/guide-design-center-configure-sketches-community-design-center-advanced.html#generate-and-execute-the-runfile)

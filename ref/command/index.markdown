...
[search the CFEngine documentation for 'command'](http://cfengine.com/docs/3.5/search.html?q=command).
...
- [command](http://cfengine.com/docs/3.5/reference-promise-types-processes.html#command)

...
pageurl: /ref/new
posttitle: Reference disambiguation for 'new'
navsection: none
---

The term 'new' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'new'](http://cfengine.com/docs/3.5/search.html?q=new).

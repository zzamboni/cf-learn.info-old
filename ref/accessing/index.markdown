...
pageurl: /ref/accessing
posttitle: Reference disambiguation for 'accessing'
navsection: none
---

The term 'accessing' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'accessing'](http://docs.cfengine.com/latest/search.html?q=accessing).

...
pageurl: /ref/update.cf
posttitle: Reference disambiguation for 'update.cf'
navsection: none
---

The term 'update.cf' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'update.cf'](http://cfengine.com/docs/latest/search.html?q=update.cf).
...
- [update.cf \#\#](http://cfengine.com/docs/latest/guide-latest-release-policy-framework-updates.html#update-cf-##)
...
- [update.cf](http://cfengine.com/docs/latest/guide-writing-and-serving-policy-policy-framework.html#update-cf)

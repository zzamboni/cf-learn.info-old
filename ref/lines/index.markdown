...
[search the CFEngine documentation for 'lines'](http://cfengine.com/docs/latest/search.html?q=lines).
...
- [Inserting lines in a file](http://cfengine.com/docs/latest/examples-example-snippets-basic-file-directory.html#inserting-lines-in-a-file)
...
- [delete_lines](http://cfengine.com/docs/latest/reference-promise-types-edit_line-delete_lines.html#delete_lines)
- [insert_lines](http://cfengine.com/docs/latest/reference-promise-types-edit_line-insert_lines.html#insert_lines)

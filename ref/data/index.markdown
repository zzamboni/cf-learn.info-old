...
pageurl: /ref/data
posttitle: Reference disambiguation for 'data'
navsection: none
---

The term 'data' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'data'](http://cfengine.com/docs/3.5/search.html?q=data).

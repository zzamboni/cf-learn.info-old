...
pageurl: /ref/this-promiser
posttitle: Reference disambiguation for 'this-promiser'
navsection: none
---

The term 'this-promiser' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'this-promiser'](http://cfengine.com/docs/latest/search.html?q=this-promiser).
...
- [this.promiser_gid](http://cfengine.com/docs/latest/reference-special-variables-this.html#this-promiser_gid)

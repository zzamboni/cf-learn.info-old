...
[search the CFEngine documentation for 'policy'](http://cfengine.com/docs/latest/search.html?q=policy).
...
- [Version Control and Configuration Policy \#\#](http://cfengine.com/docs/latest/enterprise-cfengine-guide-best-practices.html#version-control-and-configuration-policy-##)
...
- [Make policy changes](http://cfengine.com/docs/latest/examples-tutorials-distribute-files-from-a-central-location.html#make-policy-changes)
...
- [Create a patch policy](http://cfengine.com/docs/latest/examples-tutorials-distribute-files-from-a-central-location.html#create-a-patch-policy)
- [Integrate the policy](http://cfengine.com/docs/latest/examples-tutorials-distribute-files-from-a-central-location.html#integrate-the-policy)
...
- [Policy evaluation overview](http://cfengine.com/docs/latest/guide-language-concepts-normal-ordering.html#policy-evaluation-overview)
...
- [Improvements for Policy Writers \#\#](http://cfengine.com/docs/latest/guide-latest-release-whatsnew.html#improvements-for-policy-writers-##)
...
- [Layers of Abstraction in Policy](http://cfengine.com/docs/latest/guide-writing-and-serving-policy-policy-layers-abstraction.html#layers-of-abstraction-in-policy)
...
- [Policy Workflow \#\#](http://cfengine.com/docs/latest/guide-writing-and-serving-policy.html#policy-workflow-##)
...
- [service_autostart_policy](http://cfengine.com/docs/latest/reference-promise-types-services.html#service_autostart_policy)
- [policy](http://cfengine.com/docs/latest/reference-promise-types-vars.html#policy)
- [action_policy](http://cfengine.com/docs/latest/reference-promise-types.html#action_policy)
- [timer_policy](http://cfengine.com/docs/latest/reference-promise-types.html#timer_policy)

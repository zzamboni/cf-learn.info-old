...
pageurl: /ref/download
posttitle: Reference disambiguation for 'download'
navsection: none
---

The term 'download' could refer to several sections in the documentation. Please choose one below, or
[search the CFEngine documentation for 'download'](http://docs.cfengine.com/latest/search.html?q=download).
